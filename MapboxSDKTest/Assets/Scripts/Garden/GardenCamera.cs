...
namespace Garden
{
    public class GardenCamera : MonoBehaviour
    {
        ...
        public GameObject plantdexCanvas;
        ...
        private void Update()
        {
            ...
            if (Input.touchCount != 1
                ...
                || uiCanvas.activeSelf
                || plantdexCanvas.activeSelf
                || rewardCanvas.activeSelf) return;
        ...
        private void RaycastHitPlantSpot(RaycastHit hit)
        {
            ...
            if (spot.needsWater)
            {
                ...
                if (currentEnergy < neededEnergy || currentWater < neededWater || currentEnergy < 1)
                {
