    ...
    public static class Items
    {
        public static List<Item> ItemList = new(
            new Collection<Item>
            {
                ...
                new(4, "Tomato", "Juicy and vibrant, perfect for sauces and salads.", ItemType.Produce, Rarity.Common, -1, 30),
                new(5, "Cucumber", "Cool and crisp, a refreshing garden favorite.", ItemType.Produce, Rarity.Common, -1, 25),
                new(6, "Potato", "A humble tuber with endless culinary possibilities.", ItemType.Produce, Rarity.Common, -1, 27),
                new(7, "Lettuce", "Crisp and leafy, the base of any great salad.", ItemType.Produce, Rarity.Common, -1, 29),
                new(8, "Celery", "Crunchy and aromatic, great for soups or snacks.", ItemType.Produce, Rarity.Common, -1, 32),
                new(9, "Dill", "A fragrant herb that adds a burst of flavor.", ItemType.Produce, Rarity.Common, -1, 19),
                new(10, "Leek", "Mild and onion-like, ideal for hearty dishes.", ItemType.Produce, Rarity.Common, -1, 31),
                new(11, "Onion", "A kitchen essential, bringing depth to any meal.", ItemType.Produce, Rarity.Common, -1, 32),
                new(12, "Spring Onion", "Tender and zesty, a fresh garnish for any dish.", ItemType.Produce, Rarity.Common, -1, 33),
                new(13, "Cauliflower", "A versatile veggie, great roasted or riced.", ItemType.Produce, Rarity.Common, -1, 28),
                new(14, "Broccoli", "A nutritious green packed with crunch and flavor.", ItemType.Produce, Rarity.Common, -1, 28),
                new(15, "Artichoke", "A spiky treasure with a delicious heart.", ItemType.Produce, Rarity.Common, -1, 26),
                new(16, "Daikon", "A crisp, mild radish popular in Asian cuisine.", ItemType.Produce, Rarity.Common, -1, 26),
                new(17, "Rice", "Tiny grains that fuel the world's favorite dishes.", ItemType.Produce, Rarity.Common, -1, 24),
                new(18, "Sugarcane", "Sweet and fibrous, the source of pure sugar.", ItemType.Produce, Rarity.Common, -1, 33),
                new(19, "Soybean", "A protein-rich bean used in countless foods.", ItemType.Produce, Rarity.Common, -1, 25),
                new(20, "Wheat", "Golden grains that make bread, pasta, and more.", ItemType.Produce, Rarity.Common, -1, 26),
                new(21, "Cotton", "Soft and fluffy, but not for eating!", ItemType.Produce, Rarity.Common, -1, 28),
                new(22, "Sweet Potato", "A sweet, starchy root packed with nutrients.", ItemType.Produce, Rarity.Common, -1, 30),
                new(23, "Cabbage", "Layered and crisp, great for slaws and stews.", ItemType.Produce, Rarity.Common, -1, 26),
                new(24, "Spinach", "A leafy green powerhouse of vitamins.", ItemType.Produce, Rarity.Common, -1, 24),
                new(25, "Coffee Bean", "The magic bean that fuels the world.", ItemType.Produce, Rarity.Common, -1, 35),
                new(26, "Corn", "Golden kernels bursting with natural sweetness.", ItemType.Produce, Rarity.Common, -1, 22),
                new(27, "Eggplant", "Glossy and purple, a sponge for flavors.", ItemType.Produce, Rarity.Common, -1, 30),
